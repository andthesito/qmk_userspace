...
// M de Mac
#define ES_MAC_MORD KC_NUBS // º
#define ES_MAC_BSLS ALGR(ES_MAC_MORD)  // (backslash)
#define ES_MAC_LABK KC_GRV  // <
#define ES_MAC_RABK S(KC_GRV) // ª
#define ES_MAC_TILD ALGR(ES_NTIL)    // ~
